...
@Component({
  selector: 'app-sp-client-view',
  templateUrl: './sp-client-view.component.html',
  styleUrls: ['./sp-client-view.component.css']
})
export class SpClientViewComponent implements OnInit {
